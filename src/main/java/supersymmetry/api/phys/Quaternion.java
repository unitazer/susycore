...
// immutable just because i saw someone else do it like that, operations return new instances,
// not even sure if i did the math correctly so you can blame this class if your rotations get
